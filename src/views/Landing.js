  ...
  const listBand = [
    {
      ...
      rate: 1000000,
      bannerUrl:
        'https://www.nme.com/wp-content/uploads/2020/09/nirvanalogo.jpg'
    },
    {
      ...
      rate: 10000000,
      bannerUrl:
        'https://fanart.tv/api/download.php?type=download&image=89695&section=2'
    },
    {
      nama: 'Queen',
      genre: ['Rock'],
      jenis: 'Band',
      deskripsi:
        'Queen adalah grup musik rok dari Britania Raya yang dibentuk tahun 1970 di London. Semula, mereka terdiri dari Freddie Mercury, Brian May, Roger Taylor, dan John Deacon.',
      rate: 10000000,
      bannerUrl:
    ...
    },
    {
      ...
      rate: 10000000,
      bannerUrl:
        'https://upload.wikimedia.org/wikipedia/commons/thumb/9/99/Elvis_Presley_promoting_Jailhouse_Rock.jpg/1280px-Elvis_Presley_promoting_Jailhouse_Rock.jpg'
    },
    {
      nama: 'John Lennon',
      ...
      jenis: 'Soloist',
      deskripsi:
        'John Winston Ono Lennon, MBE paling dikenal sebagai penyanyi, pencipta lagu, instrumentalis, penulis, dan aktivis politik yang terkenal di seluruh dunia sebagai pemimpin dari The Beatles. Lennon dan Paul McCartney membentuk partnership pencipta lagu yang paling sukses dan berhasil hingga saat ini.',
      rate: 10000000,
      bannerUrl:
        'http://t2.gstatic.com/images?q=tbn:ANd9GcQr-dMu5bGhzbE_bG3-UkQZrS-aL_Hy8PU_glZdL43IkFXGaJo63bftnQwiWzcD'
    }
  ]
