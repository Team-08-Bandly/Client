            ...
            <nav className="relative max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6" aria-label="Global">
                <div className="flex items-center flex-1">
                    ...
                    <div className="hidden space-x-8 md:flex md:ml-10">
                        <a href="#" className="text-base font-medium text-gray-500 hover:text-gray-300">Home</a>

                        <a href="#" className="text-base font-medium text-gray-500 hover:text-gray-300">Band</a>

                        <a href="#" className="text-base font-medium text-gray-500 hover:text-gray-300">Soloist</a>
